...
import { setIngredientDetails, deleteIngredientDetails } from '../actions/ingredient-details';
...
describe('ingredient-details reducer test', () => {
    ...
    it('should return the initial state if delete ingredient details', () => {
        expect(reducer({ ...state, ingredientDetails: ingredientMain }, deleteIngredientDetails()))
            .toEqual(state)
    })
})
